...
const AuthorLayout = () => {
    ...
    const navItems = [
        { path: '/author', end: true, icon: LayoutDashboard, label: t('dashboard') },
        { path: '/author/content', icon: BookOpen, label: t('my_manuscripts') },
        { path: '/author/content/new', icon: PlusCircle, label: t('new_manuscript') },
    ];
                    ...
                    <div className="p-4 border-t border-gray-100">
                        ...
                        >
                            ...
                            <div className={`overflow-hidden transition-all ${isSidebarOpen ? 'w-auto opacity-100' : 'w-0 opacity-0 lg:w-auto lg:opacity-100'}`}>
                                <p className="text-sm font-medium text-gray-700 truncate">{user?.full_name || t('author')}</p>
